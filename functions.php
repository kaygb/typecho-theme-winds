...
* @return void
*/
function theNext($widget, $defaultBanner)
{
  $db = Typecho_Db::get();
  ...
  $pic = $ji->fields->pic ? $ji->fields->pic:$defaultBanner . "?_=" . mt_rand();
  ...
  $link = '<a class="carousel" title="没啦"><div style="background-image:url('.$defaultBanner.');" class="card-img tu"></div><div class="carousel-indicators"><h3 class="heading-title text-info blackback" style="text-transform:none;">没啦</h3></div></a>';
  echo $link;
  }
}
...
* @return void
*/
function thePrev($widget, $defaultBanner)
{
  $db = Typecho_Db::get();
  $sql = $db->select()->from('table.contents')
  ->where('table.contents.created < ?', $widget->created)
  ...
  $link = '<a title="没啦" class="carousel"><div style="background-image:url('.$defaultBanner.');" class="card-img tu"></div><div class="carousel-indicators"><h3 class="heading-title text-info blackback" style="text-transform:none;">没啦</h3></div></a>';
  echo $link;
  }
}